  ...
  return (
    <InviteProvider>
      <Page>
          ...
          <Stack spacing={6}>
            ...
            <UserStatList>
              ...
              {totalQualifiedFlips > 0 && (
                ...
                >
                  <UserStatValue>
                    {Math.min(totalShortFlipPoints, totalQualifiedFlips)} out of{' '}
                    {totalQualifiedFlips} (
                    {toPercent(
        ...
        <SpoilInviteDrawer isOpen={isOpenSpoilForm} onClose={onCloseSpoilForm}>
          <SpoilInviteForm
            onSpoil={async key => {
              try {
                ...
                toast({
                  // eslint-disable-next-line react/display-name
                  render: () => (
                    <Toast title={t('Invitation is missing')} status="error" />
                  ),
                })
              }
            }}
