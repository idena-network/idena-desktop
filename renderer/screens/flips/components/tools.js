...
export function FlipRatingTooltip({onClose}) {
  ...
  const rewards = ['Basic reward', 'Reward x2', 'Reward x3', 'Reward x4']
          ...
          <Box ref={contextMenuRef} minWidth={400}>
            ...
            <Absolute bottom="100%" left={-20} zIndex={100}>
              ...
              >
                ...
                >
                  Get extra rewards for secure flips (experimental)
                </Box>
                {rewards.map((val, i) => (
                  <Flex inline marginBottom={rem(10)}>
                    <Box
                      style={{
